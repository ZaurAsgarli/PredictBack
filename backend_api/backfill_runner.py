...
# Setup Django if run standalone (though shell handles this)
...
print("--- STARTING LIQUIDITY BACKFILL ---")
...
if not admin:
    ...
    if LiquidityEvent.objects.count() > 100:
        print("LiquidityEvents already exist. Skipping backfill.")
    else:
        for m in markets:
            # Initial
