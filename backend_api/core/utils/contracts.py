...
class ContractService:
    ...
    def __init__(self):
        ...
        self.chain_id: int = 11155111  # Ethereum Sepolia
    ...
    def _initialize_web3(self):
        ...
        self.chain_id = getattr(settings, 'CHAIN_ID', 11155111)  # Default to Ethereum Sepolia
        ...
        try:
            ...
            # Auto-detect POA compatibility (some testnets use POA)
            if self.chain_id in [84532, 84531, 11155111]:  # Base Sepolia, Base Goerli, Ethereum Sepolia
                try:
        ...
        try:
            if event_name:
                ...
                for evt_name in event_names:
                    ...
                    if event:
                        try:
                            events.extend(event.get_logs(from_block=from_block, to_block=to_block))
                        except Exception as e:
